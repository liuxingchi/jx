...
function page(current){
	var current = current;
	//获得总数据量
	var json = {"mark":"0","category_id":CATEGORY,"province":PROVINCE,"city":CITY,"workyears_min":WORKYEARS_MIN,"workyears_max":WORKYEARS_MAX,"keyword":KEYWORD};
            ajaxPost(
              ...
              function(data, textStatus){
				  ...
				  $("#driver_list_num").html("共"+count+"条");
				if(current == 0)
					{
