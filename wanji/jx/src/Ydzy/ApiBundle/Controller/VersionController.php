...
class VersionController extends Controller
{
		public function getversionAction(Request $request)    //admin 获得版本
    {
    		...
    		$query = $query->orderBy('v.create_date','DESC');
    		...
    		if(!$versions){
				...
				$json_r = array(
						...
						'releaseNotes' => $description,
					 	'url' => "http://wanjiwang.cn".$filepath,
					 	'filesize' => $filesize,
					 	'md5sum' => $md5sum,
	...
	public function downloadWebAction()
    {
        return $this->render('YdzyApiBundle:Default:download.html_1.twig');
    } 
}