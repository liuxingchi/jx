...
public function result(){
	...
	//$this->get_bucket_acl($oss_sdk_service);
	
	//set_bucket_logging($oss_sdk_service);
	//$this->get_bucket_logging($oss_sdk_service);
	 ...
	 * Object相关操作
	 */
	//$this->list_object($oss_sdk_service);
	//create_directory($oss_sdk_service);
    //upload_by_content($oss_sdk_service);
   	$this->upload_by_file($oss_sdk_service);
...
function upload_by_file($obj){
	$bucket = 'wanji';
	$object = 'logo.png';	
	$file_path = "/home/wwwroot/jx/web/logo.png";
