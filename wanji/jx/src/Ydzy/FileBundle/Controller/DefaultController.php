...
class DefaultController extends Controller
{
	...
	public function uploadImageAction(Request $request)
	{
		...
		$sql = "select `value` from Config where `key` = 'upload'";
		$result = mysql_query($sql);
		$upload = mysql_result($result,0);
    ...
    /***********************************
	 *
	 * Textimage::uploadImagewithnothumb
	 *
	 ***********************************/
	public function uploadImageWithNoThumbAction(Request $request)
	{
		// consts
		$uploadedDirPrefix = '/uploadnew/';
		$origFilePrefix = '0';
